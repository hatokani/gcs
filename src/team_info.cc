...
Team_info::Team_info(std::string color_) : color(color_), score(0), goalie(0), red_cards(0), yellow_cards(0), yellow_card_times(0), timeouts(0), timeout_times(0){}
...
void Team_info::set_yellow_card_times(unsigned value) { yellow_card_times = value; }
